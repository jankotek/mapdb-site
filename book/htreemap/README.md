...
<!--- #file#htreemap_noserializer.java--->
```java
...
<!--- #file#htreemap_value_loader.java--->
```java
HTreeMap<String,Long> map = db
        .hashMap("map", Serializer.STRING, Serializer.LONG)
        .valueLoader(s -> 1L)
...
<!--- #file#htreemap_expiration_ttl_limit.java--->
```java
...
<!--- #file#htreemap_expiration_space_limit.java--->
```java
...
<!--- #file#htreemap_expiration_size_limit.java--->
```java
HTreeMap cache = db
        .hashMap("cache")
        .expireMaxSize(128)
...
<!--- #file#htreemap_expiration_create_update.java--->
```java
HTreeMap cache = db
        .hashMap("cache")
...
<!--- #file#htreemap_expiration_noexpire.java--->
```java
HTreeMap cache = db
        .hashMap("cache")
        .expireMaxSize(1000)
...
<!--- #file#htreemap_expiration_background.java--->
```java
...
<!--- #file#htreemap_expiration_sharded.java--->
```java
...
<!--- #file#htreemap_expiration_sharded2.java--->
```java
HTreeMap cache = DBMaker
        .memoryShardedHashMap(16)
        .expireAfterUpdate()
...
<!--- #file#htreemap_overflow_init.java--->
```java
DB dbDisk = DBMaker
        .fileDB(file)
        .make();
...
<!--- #file#htreemap_overflow_remove.java--->
```java
...
<!--- #file#htreemap_overflow_get.java--->
```java
...
<!--- #file#htreemap_overflow_clear.java--->
```java
inMemory.put(1,11);
inMemory.put(2,11);
