...
Good performance is result of compromise between consistency,
...
Make sure you understand implications and read `Javadoc on DBMaker <http://www.mapdb.org/javadoc/latest/mapdb/org/mapdb/DBMaker.Maker.html>`_.
...
.. literalinclude:: ../src/test/java/doc/performance_transaction_enable.java
    :start-after: //a
    :end-before: //z
    :language: c++
    :dedent: 8
...
however this does not protect your data if JVM crashes or is killed. Use ``DBMaker.closeOnJvmShutdown()`` option to enable it.

With transactions disabled you do not have rollback capability,
...
MapDB was designed from ground to take advantage of mmap files. However on 32bit JVM
...
By default we use a slower and safer disk access mode called Random-Access-File (RAF).
...
That means that mmap file remains open even after ``db.close()`` is called.
...
Use ``DBMaker.cleanerHackEnable()`` to enable it.

Here is example with all mmap related options:

.. literalinclude:: ../src/test/java/doc/performance_mmap.java
    :start-after: //a
    :end-before: //z
    :language: c++
    :dedent: 8
...
.. literalinclude:: ../src/test/java/doc/performance_filechannel.java
    :start-after: //a
    :end-before: //z
    :language: c++
    :dedent: 8
...
.. literalinclude:: ../src/test/java/doc/performance_memory_heap.java
    :start-after: //a
    :end-before: //z
    :language: c++
    :dedent: 8
...
.. literalinclude:: ../src/test/java/doc/performance_memory_byte_array.java
    :start-after: //a
    :end-before: //z
    :language: c++
    :dedent: 8
...
.. literalinclude:: ../src/test/java/doc/performance_memory_direct.java
    :start-after: //a
    :end-before: //z
    :language: c++
    :dedent: 8
...
.. literalinclude:: ../src/test/java/doc/performance_allocation.java
    :start-after: //a
    :end-before: //z
    :language: c++
    :dedent: 8
