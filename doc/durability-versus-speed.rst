...
If process dies in middle of write, storage files might become
...
Other important usage is for initial data import. Transactions and
...
finished, store gets reopened with transactions enabled.
...
disk access mode called Random-Access-File (RAF).

Mmap files are much faster compared to RAF. Exact speed bonus depends on
