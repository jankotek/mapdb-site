...
``VERSION`` is the last version number from `here <http://mvnrepository.com/artifact/org.mapdb/mapdb>`_.
...
.. literalinclude:: ../src/test/java/doc/hello_world_memory.java
    :start-after: //a
    :end-before: //z
    :language: c++
    :dedent: 8
