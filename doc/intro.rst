...
It provides Maps, Sets, Lists, Queues, Bitmaps with range queries, expiration, compression, off-heap storage and streaming.
...
This manual is a work-in-progress and it will be completed together with the MapDB 3.0 release.
We hope you will find it useful. If you'd like to contribute to MapDB, we would be very happy to accept
